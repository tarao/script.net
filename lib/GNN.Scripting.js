...
package GNN.Scripting {
    ...
    class Runner {
        ...
        static class Cache {
            ...
            function debugLoad() : Cache {
                if (!this.failed && !this.loaded && this.options.debug) {
                    this.load();
                }
                return this.loaded ? this : null;
            }

            function debugUnload() : void {
                if (this.options.debug) this.unload();
            }
