    ...
    class Runner implements IDisposable {
        ...
        static class Cache {
            ...
            function load() : Cache {
                ...
                if (app.runner.compile(this.fname)) {
                    this.app = app;
                    return this;
                } else {
                    app.clean();
            ...
            function run(...args : String[]) {
                if (this.loaded) {
                    var cmd : String[] = [ this.fname ].concat(args);
        ...
        function load(fname : String, options : Object) : Cache {
        ...
        function run(fname : String, ...args : String[]) {
            var id : String = getId(fname);
            var cache : Cache = this.cache[id] || this.load(fname, null);
