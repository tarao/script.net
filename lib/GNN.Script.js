    ...
    class Source {
        ...
        function map(func) {
            for (var i=0; i < this.lines.length; i++) {
                this.lines[i] = func(this.lines[i]);
            }
            return this;
        }
        ...
        function flatten() {
            ...
            for (var i=0; i < this.lines.length; i++) {
                var line = (this.lines[i] instanceof Source) ?
                        this.lines[i].flatten() : [ this.lines[i] ];
    ...
    class Script extends MarshalByRefObject {
            ...
            function translate(source : Source) : Source {
                ...
                return source.map(function(line) {
                    ...
                    if (m) {
                        ...
                        return new Source(File.ReadAllLines(file));
                    }
                    return line;
                });
            }
        ...
        function translate(source : Source) : Source {
            ...
            for (var i=0; i < translators.length; i++) {
                source = translators[i].translate(source.flatten());
            }
            return source;
        }
        ...
        : CompilerResults {
            ...
            // compile
            // TODO: error message
            source = [this.translate(source).toString()];
